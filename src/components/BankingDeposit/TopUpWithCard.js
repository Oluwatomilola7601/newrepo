...
import "../../styles/topupwithcard.css";
import { Link } from "react-router-dom/cjs/react-router-dom.min";


function TopUpWithCard() {
  return (
    <div>
      ...
      <div>
        ...
        <center>
          <input type="number" className="input-num" placeholder="#200,000.00" />
        </center>
      </div>
      <center>
        <div className="mt-3">
          <p className="card-details">
            Enter your card details to top up your wallet
          </p>
        ...
        <div className="cvv-expire">
          <div className="input-hold2">
            <input
              type="text"
              disabled
            ...
            <input
              type="text"
              className="card-num"
              placeholder="May      1986"
            />
          </div>
          <div className="input-hold3">
            <input
              type="text"
              disabled
              placeholder="CVV"
