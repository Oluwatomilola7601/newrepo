...
import "../../styles/transfertobank.css";
  ...
  return (
    <div>
      <div className="Airtimeheader">
        ...
        <h5 className="mt-2 airtimedata">Transfer to Bank</h5>
        <svg
          className="svgg2"
          xmlns="http://www.w3.org/2000/svg"
          width="25"
      ...
      <div className="input-hold">
        <h5 className="h4">Transfer to other bank account</h5>
        <input type="number" name="" id="" placeholder="Amount in NGN" />
        <p>How would you like to send</p>
        <input type="number" name="" id="" placeholder="Account Number:" />
        <input type="number" name="" id="" placeholder="Bank Name:" />
        <h5>Account name:</h5>
        <input type="remark" name="" id="" placeholder="Remark(optional)" />
      </div>
      <p>
        This request expires in 24 hours and will only work for this
        transaction.
      </p>
      <div className="bal-show">
        <p>SavePoint Balance</p>
        <p>£14,355.44</p>
      </div>
      <center>
        <Link to="/verifytransfer">
          {" "}
          <button className="button-1">TRANSFER</button>
        </Link>
      </center>
    </div>
  );
